...
fun housePage(): Page = Page(
    ...
    regions = listOf(
        ...
        area("window", "window", Crayons.SKY, circle(0.355, 0.555, 0.055)),
...
/** Flowers: two blossoms on leafy stems, under one small cloud. */
fun flowersPage(): Page = Page(
    ...
    regions = listOf(
        ...
        areaOf("petals_a", "petals", Crayons.PINK, flowerPetals(0.36, 0.44, 0.17)),
        area("center_a", "flower_center", Crayons.YELLOW, circle(0.36, 0.44, 0.051)),
        areaOf("petals_b", "petals", Crayons.PINK, flowerPetals(0.64, 0.36, 0.14)),
