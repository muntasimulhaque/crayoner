...
fun iceCreamPage(): Page = Page(
    id = "icecream",
    regions = listOf(
        area("wall", "wall", Crayons.SAND, rect(0.0, 0.0, 1.0, 1.0)),
        area("cone", "cone", Crayons.BROWN, poly(0.375, 0.44, 0.625, 0.44, 0.50, 0.885)),
        area("scoop_a", "scoop", Crayons.PINK, circle(0.50, 0.415, 0.15)),
        area("scoop_b", "scoop", Crayons.WHITE, circle(0.50, 0.255, 0.125)),
...
/** Cupcake: a teal wrapper, a pink swirl, a cherry, sprinkles. */
fun cupcakePage(): Page = Page(
    id = "cupcake",
    regions = listOf(
        area("wall", "wall", Crayons.LILAC, rect(0.0, 0.0, 1.0, 1.0)),
        area("table", "table", Crayons.BROWN, rect(0.0, 0.80, 1.0, 0.20)),
        area("wrapper", "wrapper", Crayons.TEAL, poly(0.35, 0.56, 0.65, 0.56, 0.61, 0.82, 0.39, 0.82)),
        area(
            "frosting", "frosting", Crayons.PINK,
...
/** Car: a red car on a gray road, two blue windows, two round wheels. */
...
/** Train: a red engine with a blue window, three wheels, brown rails. */
